...
const CORE_ASSETS = [
  './index.html',
  './manifest.json',
  './icons/icon-192.pngconst CACHE_NAME = 'moderndiary-v3'; // naikkan versi tiap deploy besar supaya cache lama otomatis dibuang
...
self.addEventListener('fetch', (event) => {
  ...
  if (isHTML) {
    // NETWORK-FIRST + no-store: paksa SELALU ambil versi terbaru dari server,
    // jangan biarkan browser pakai HTTP cache biasa untuk request ini.
    // Cache Storage cuma dipakai sebagai cadangan kalau benar-benar offline.
    event.respondWith(
